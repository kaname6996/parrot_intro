...
export default class Breed extends Component {
    ...
    state={
        pic:[
        {id:'01',name:'太平洋',pic:'parrot_intro/media/太平洋.jpg'},
        {id:'02',name:'愛情鳥',pic:'parrot_intro/media/愛情鳥.jpg'},
        {id:'03',name:'玄鳳',pic:'parrot_intro/media/玄鳳.jpg'},
        {id:'04',name:'橫斑',pic:'parrot_intro/media/橫斑.jpg'},
        {id:'05',name:'凱克',pic:'parrot_intro/media/凱克.png'},
        {id:'06',name:'金太陽',pic:'parrot_intro/media/金太陽.jpg'},
        {id:'07',name:'巴丹',pic:'parrot_intro/media/巴丹.jpg'},
        {id:'08',name:'灰鸚',pic:'parrot_intro/media/灰鸚.jpg'},
        {id:'09',name:'和尚',pic:'parrot_intro/media/和尚.jpg'},
    ],
        breed_picbox:false,
        img:''
    }
