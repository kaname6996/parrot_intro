...
import Nav from '../../components/Nav'
 class About extends Component {
    ...
    state={news:[
        {id:'01',name:'研究：這種鸚鵡為躲避人類才搬到高山上棲息',txt:'在新西蘭的高山上，生活著世界上唯一一種高山鸚鵡，英文名叫Kea。這種鸚鵡因經常襲擊山區的綿羊，被稱為「啄羊鸚鵡」，又因生性好奇，經常被登山的人們吸引，甚至有可能會翻檢遊人的隨身物品。',url:'https://www.epochtimes.com/b5/21/6/1/n12990383.htm',pic:'./media/Kea.jpg'},
        {id:'02',name:'一野生金剛鸚鵡 每天飛動物園「找真愛」',txt:'根據《美聯社》的報導，巴西熱內盧（Rio de Janeiro）的一處動物園，每天都會從外地飛來1隻野生的藍黃金剛鸚鵡，而且持續20年之久，因此園方對於這隻野生鸚鵡相當熟悉，還為牠取名為茱麗葉（Juliet）並持續觀察牠的一舉一動。',url:'https://www.chinatimes.com/hottopic/20210510004040-260809?chdtv',pic:'./media/news2.jpg'},
        {id:'03',name:'雲林街頭出現鸚鵡！ 7隻金剛鸚鵡排排站機車超拉風',txt:'有民眾拍到騎士機車上排站9隻鸚鵡兜風，PO網引起熱烈討論；鳥主「依藤」今天表示，養鸚鵡已6年，當天是載著鸚鵡到河堤「放飛」，若嚇到民眾真得很抱歉。',url:'https://news.ltn.com.tw/news/life/breakingnews/3459049',pic:'./media/news3.jpg'},
    ],
    show:false    
}
    ...
    render() {
        ...
        return (
            ...
            <div className='about'>
                ...
                {/* 左上懸浮巴丹 */}
                <div className='left'>
                    <img src="./media/2454492.png" alt="" onClick={this.show} />
